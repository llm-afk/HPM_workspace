...
# bsp lib config
HPM_SDK_BASE = os.path.normpath(os.getcwd() + '/../../../hpm_sdk')
...
if  CROSS_TOOL == 'gcc':
    ...
    if os.getenv('RTT_RISCV_TOOLCHAIN'):
        ...
        EXEC_PATH   = r'C:\Users\32196\Desktop\sdk_env_v1.11.0\toolchains\rv32imac_zicsr_zifencei_multilib_b_ext-win\bin'
else:
